...
2、后台运行程序
进入bin目录执行
./startGts2.sh start|stop|restart
...
4、增加开机自启动脚本（Centos7）
4.1、首先，脚本具有可执行权限
chmod +x /opt/gts2-bi-1.0-SNAPSHOT/bin/startDataShareCenter.sh
4.12、然后将脚本存放的绝对路径+脚本全名追加到/etc/rc.d/rc.local文件最后
/opt/gts2-bi-1.0-SNAPSHOT/bin/startDataShareCenter.sh restart #springboot服务
